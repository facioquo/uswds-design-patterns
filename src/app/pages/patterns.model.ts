...
export const PATTERNS: Card[] = [
  {
    ...
    "imageMeta": "/assets/thumbnails/card-catalog.png?v=YYYY.MM.DD"
  },
  {
    "id": "hero-overlay",
    ...
    "imageMeta": "/assets/thumbnails/hero-overlay.png?v=YYYY.MM.DD"
  },
  {
    "id": "bubbles",
    ...
    "imageMeta": "/assets/thumbnails/bubbles.png?v=YYYY.MM.DD"
  },
  {
    "id": "sticky-menu",
    ...
    "imageMeta": "/assets/thumbnails/sticky-menu.png?v=YYYY.MM.DD"
  }
]
